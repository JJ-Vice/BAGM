...
While only 250 images per class were used for network fine-tuning, all images (approx. 1400) of the Marketable Foods (MF) Dataset is available on [IEEE Dataport](https://ieee-dataport.org/documents/marketable-foods-mf-dataset)
